...
export function buildDelegationDeveloperInstructions(
  ...
  return [
    ...
    "When you complete meaningful work, record a supervisor report before your final reply with `manor-harness report --status completed --summary \"<concise outcome>\" --details \"<what changed, which proof was recorded, and any remaining risk>\"`.",

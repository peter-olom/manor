...
export function formatHarnessRuntimeModel(): string[] {
  return [
    ...
    "If the browser proof sidecar is unavailable, retry briefly and then report the proof blocker through Manor. Do not replace it with an unrelated browser installation.",
